...
IRCProxyConnection.prototype.check_auth = function () {
  ...
  if (self.username && self.api_secret && !self.sent_welcome) {
    ...
    //:cameron.freenode.net 001 ggreer_test :Welcome to the freenode Internet Relay Chat Network ggreer_test
...
IRCProxyConnection.prototype.pipe_data = function (err, reason) {
  var self = this;
