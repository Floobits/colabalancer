...
IRCColabConnection.prototype.forward_data = function (p, err, reason) {
  var self = this,
    colab_conn;
...
IRCColabConnection.prototype.handle_msg = function (p, msg) {
  var self = this,
    colab_conn = self.colab_conns[p];
...
IRCMultiplexer.prototype.colab_disconnect = function (p, err, reason) {
  var self = this,
    colab_conn = self.colab_conns[p];
